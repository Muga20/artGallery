...
function AdminSidebar({ open, setOpen, loading, setLoading }) {
  return (
    <nav
      className={`fixed top-0 transition-all lg:mt-0 mt-16 left-0 dark:bg-gray-900 bottom-0 flex flex-col ${
        open ? "w-[280px]" : "w-0"
      } shadow bg-gray-50 overflow-hidden z-50`}
      id="sidenav"
    >
      ...
      <div className="pb-6 mt-4 overflow-x-hidden overflow-y-auto">
        <ul className="mb-8 text-sm">
          <li>
            ...
            >
              <span className="drop-shadow-lg mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white dark:bg-gray-800 dark:text-gray-100 bg-center text-center xl:p-2.5">
                <svg
                ...
                >
                  {/* Add the path data for the SVG icon here */}
                  <path
